...
namespace System.Security.Cryptography
{
	...
	{
		// Token: 0x060050C0 RID: 20672 RVA: 0x00120EF0 File Offset: 0x0011FEF0
		...
		// Token: 0x060050C1 RID: 20673 RVA: 0x00120F4A File Offset: 0x0011FF4A
		...
		// Token: 0x060050C2 RID: 20674 RVA: 0x00120F7A File Offset: 0x0011FF7A
		protected override void HashCore(byte[] rgb, int ibStart, int cbSize)
		{
			this._HashData(rgb, ibStart, cbSize);
		}

		// Token: 0x060050C3 RID: 20675 RVA: 0x00120F85 File Offset: 0x0011FF85
		protected override byte[] HashFinal()
		{
			return this._EndHash();
		}

		// Token: 0x060050C4 RID: 20676 RVA: 0x00120F90 File Offset: 0x0011FF90
		...
		// Token: 0x060050C5 RID: 20677 RVA: 0x00121030 File Offset: 0x00120030
		...
		// Token: 0x060050C6 RID: 20678 RVA: 0x0012115C File Offset: 0x0012015C
		...
		// Token: 0x060050C7 RID: 20679 RVA: 0x00121250 File Offset: 0x00120250
		...
		// Token: 0x060050C8 RID: 20680 RVA: 0x00121563 File Offset: 0x00120563
		private static ulong RotateRight(ulong x, int n)
		{
			return x >> n | x << 64 - n;
		}

		// Token: 0x060050C9 RID: 20681 RVA: 0x00121575 File Offset: 0x00120575
		private static ulong Ch(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ ((x ^ ulong.MaxValue) & z);
		}

		// Token: 0x060050CA RID: 20682 RVA: 0x00121581 File Offset: 0x00120581
		private static ulong Maj(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ (x & z) ^ (y & z);
		}

		// Token: 0x060050CB RID: 20683 RVA: 0x0012158E File Offset: 0x0012058E
		private static ulong Sigma_0(ulong x)
		{
			return SHA384Managed.RotateRight(x, 28) ^ SHA384Managed.RotateRight(x, 34) ^ SHA384Managed.RotateRight(x, 39);
		}

		// Token: 0x060050CC RID: 20684 RVA: 0x001215AA File Offset: 0x001205AA
		private static ulong Sigma_1(ulong x)
		{
			return SHA384Managed.RotateRight(x, 14) ^ SHA384Managed.RotateRight(x, 18) ^ SHA384Managed.RotateRight(x, 41);
		}

		// Token: 0x060050CD RID: 20685 RVA: 0x001215C6 File Offset: 0x001205C6
		private static ulong sigma_0(ulong x)
		{
			return SHA384Managed.RotateRight(x, 1) ^ SHA384Managed.RotateRight(x, 8) ^ x >> 7;
		}

		// Token: 0x060050CE RID: 20686 RVA: 0x001215DB File Offset: 0x001205DB
		private static ulong sigma_1(ulong x)
		{
			return SHA384Managed.RotateRight(x, 19) ^ SHA384Managed.RotateRight(x, 61) ^ x >> 6;
		}

		// Token: 0x060050CF RID: 20687 RVA: 0x001215F4 File Offset: 0x001205F4
