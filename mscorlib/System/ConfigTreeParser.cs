...
namespace System
{
	...
	{
		// Token: 0x06000753 RID: 1875 RVA: 0x00017D47 File Offset: 0x00016D47
		internal ConfigNode Parse(string fileName, string configPath)
		{
			return this.Parse(fileName, configPath, false);
		}

		// Token: 0x06000754 RID: 1876 RVA: 0x00017D54 File Offset: 0x00016D54
		internal ConfigNode Parse(string fileName, string configPath, bool skipSecurityStuff)
		{
			...
			{
				throw new ApplicationException(string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("XML_Syntax_InvalidSyntaxInFile"), new object[]
				{
					fileName,
					this.lastProcessed
				}), innerException);
		...
		// Token: 0x06000755 RID: 1877 RVA: 0x00017EBC File Offset: 0x00016EBC
		public void NotifyEvent(ConfigEvents nEvent)
		{
		}

		// Token: 0x06000756 RID: 1878 RVA: 0x00017EC0 File Offset: 0x00016EC0
		...
		// Token: 0x06000757 RID: 1879 RVA: 0x00017F14 File Offset: 0x00016F14
		...
		// Token: 0x06000758 RID: 1880 RVA: 0x00017FBE File Offset: 0x00016FBE
		...
		// Token: 0x06000759 RID: 1881 RVA: 0x00017FC0 File Offset: 0x00016FC0
		...
		// Token: 0x0600075A RID: 1882 RVA: 0x000180A8 File Offset: 0x000170A8
		...
		// Token: 0x0600075B RID: 1883 RVA: 0x00018135 File Offset: 0x00017135
