	...
	public abstract class UpDownBase : ContainerControl
	{
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			if (Application.RenderWithVisualStyles)
			{
				...
				visualStyleRenderer.DrawBackground(e.Graphics, clientRectangle, clipRectangle2);
				visualStyleRenderer.DrawBackground(e.Graphics, clientRectangle, clipRectangle3);
				visualStyleRenderer.DrawBackground(e.Graphics, clientRectangle, clipRectangle4);
				visualStyleRenderer.DrawBackground(e.Graphics, clientRectangle, clipRectangle5);
		...
		private void PositionControls()
		{
			...
			{
				bounds = rectangle;
				bounds.Size = new Size(rectangle.Width - 16, rectangle.Height);
			}
			if (this.upDownButtons != null)
			{
				...
				empty = new Rectangle(rectangle.Right - 16 + num2, rectangle.Top - num2, 16, rectangle.Height + num2 * 2);
			}
