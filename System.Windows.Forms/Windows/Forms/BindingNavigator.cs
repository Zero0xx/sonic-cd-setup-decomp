	...
	public class BindingNavigator : ToolStrip, ISupportInitialize
	{
		...
		protected virtual void RefreshItemsCore()
		{
			...
			else
			{
				...
				enabled = ((IBindingList)this.bindingSource).AllowNew;
				flag = ((IBindingList)this.bindingSource).AllowRemove;
			}
			if (!base.DesignMode)
			{
				...
				{
					this.addNewItem.Enabled = enabled;
				}
				if (this.DeleteItem != null)
				{
					this.deleteItem.Enabled = (flag && num > 0);
				}
