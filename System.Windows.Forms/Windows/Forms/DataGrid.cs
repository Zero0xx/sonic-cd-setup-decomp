			...
			if (keyCode <= Keys.Delete)
			{
				...
				if (keyCode != Keys.Return)
				{
					...
					case Keys.Right:
						...
						{
							int num10 = this.MoveLeftRight(this.myGridTable.GridColumnStyles, this.currentCol, true);
							if (num10 == gridColumnStyles.Count + 1)
							{
								this.CurrentColumn = num;
								this.CurrentRow++;
							}
					...
					case Keys.Down:
						...
						if (keyEventArgs.Control && !keyEventArgs.Alt)
						{
							if (keyEventArgs.Shift)
							{
								...
								{
									array8[num12].Selected = true;
								}
								this.numSelectedRows = this.currentRow - num11 + 1;
								this.EndEdit();
								return true;
							}
							this.ResetSelection();
				...
				if (keyCode <= Keys.Subtract)
				{
					...
					else
					{
						...
						if (keyEventArgs.Control && !keyEventArgs.Alt)
						{
							...
							for (int num13 = 0; num13 < this.DataGridRowsLength; num13++)
							{
								if (array10[num13] is DataGridRelationshipRow)
								{
									array10[num13].Selected = true;
								}
							}
