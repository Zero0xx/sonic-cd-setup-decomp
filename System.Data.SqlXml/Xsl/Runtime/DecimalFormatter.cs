		...
		public DecimalFormatter(string formatPicture, DecimalFormat decimalFormat)
		{
			...
			for (int i = 0; i < formatPicture.Length; i++)
			{
				...
				if (c5 == decimalFormat.digit)
				{
					if (flag3 && flag)
					{
						throw XsltException.Create("Xslt_InvalidFormat1", new string[]
						{
							formatPicture
						});
					}
				...
				else if (c5 == decimalFormat.zeroDigit)
				{
					if (flag4 && !flag)
					{
						throw XsltException.Create("Xslt_InvalidFormat2", new string[]
						{
							formatPicture
						});
					}
				...
				else if (c5 == decimalFormat.patternSeparator)
				{
					...
					if (flag2)
					{
						throw XsltException.Create("Xslt_InvalidFormat3", new string[]
						{
							formatPicture
						});
					}
				...
				else if (c5 == c)
				{
					if (flag5)
					{
						throw XsltException.Create("Xslt_InvalidFormat5", new string[]
						{
							formatPicture
						});
					}
