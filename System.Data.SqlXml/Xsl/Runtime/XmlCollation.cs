	...
	public sealed class XmlCollation
	{
		...
		internal static XmlCollation Create(string collationLiteral)
		{
			...
			if (leftPart == "http://collations.microsoft.com")
			{
				...
				{
					throw new XslTransformException("Coll_UnsupportedLanguage", new string[]
					{
						text
					});
				}
			...
			{
				throw new XslTransformException("Coll_Unsupported", new string[]
				{
					collationLiteral
				});
			}
			...
			if (query.Length != 0)
			{
				...
				}))
				{
					...
					if (array2.Length != 2)
					{
						throw new XslTransformException("Coll_BadOptFormat", new string[]
						{
							text3
						});
					}
					...
					else
					{
						if (text5 == "1" || text5 == "TRUE")
						{
							...
							throw new XslTransformException("Coll_UnsupportedOpt", new string[]
							{
								array2[0]
							});
						}
			...
			if (text2 != null && xmlCollation.cultinfo != null)
			{
				...
				throw new XslTransformException("Coll_UnsupportedSortOpt", new string[]
				{
					text2
				});
			}
