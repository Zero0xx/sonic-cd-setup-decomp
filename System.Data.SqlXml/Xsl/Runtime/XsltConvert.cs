...
namespace System.Xml.Xsl.Runtime
{
	...
	public static class XsltConvert
	{
		...
		public static XPathNavigator ToNode(IList<XPathItem> listItems)
		{
			...
			throw new XslTransformException("Xslt_NodeSetNotNode", new string[]
			{
				string.Empty
			});
		}
		...
		public static IList<XPathNavigator> EnsureNodeSet(IList<XPathItem> listItems)
		{
			if (listItems.Count == 1)
			{
				...
				if (!xpathItem.IsNode)
				{
					throw new XslTransformException("XPath_NodeSetExpected", new string[]
					{
						string.Empty
					});
				}
				...
				{
					throw new XslTransformException("XPath_RtfInPathExpr", new string[]
					{
						string.Empty
					});
				}
