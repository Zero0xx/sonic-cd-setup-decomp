...
namespace System.Xml.Xsl.Xslt
{
	...
	internal class ScriptClass
	{
		...
		{
			string errorText = XslTransformException.CreateMessage("Xslt_ScriptCompileException", new string[]
			{
				e.Message
			});
			return new CompilerError(this.endFileName, this.endLine, this.endPos, string.Empty, errorText);
		}
