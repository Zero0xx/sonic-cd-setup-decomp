...
namespace System.Security.Cryptography
{
	...
	public sealed class CryptographicAttributeObject
	{
		...
		internal CryptographicAttributeObject(IntPtr pAttribute) : this((CAPIBase.CRYPT_ATTRIBUTE)Marshal.PtrToStructure(pAttribute, typeof(CAPIBase.CRYPT_ATTRIBUTE)))
		{
		}

		// Token: 0x060000A3 RID: 163 RVA: 0x00003780 File Offset: 0x00002780
		internal CryptographicAttributeObject(CAPIBase.CRYPT_ATTRIBUTE cryptAttribute) : this(new Oid(cryptAttribute.pszObjId), PkcsUtils.GetAsnEncodedDataCollection(cryptAttribute))
		{
		}

		// Token: 0x060000A4 RID: 164 RVA: 0x0000379A File Offset: 0x0000279A
		internal CryptographicAttributeObject(CAPIBase.CRYPT_ATTRIBUTE_TYPE_VALUE cryptAttribute) : this(new Oid(cryptAttribute.pszObjId), PkcsUtils.GetAsnEncodedDataCollection(cryptAttribute))
		{
		}
