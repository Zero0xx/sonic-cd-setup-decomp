...
namespace System.Security.Cryptography.Pkcs
{
	...
	public sealed class SubjectIdentifier
	{
		...
		internal SubjectIdentifier(CAPIBase.CERT_INFO certInfo) : this(certInfo.Issuer, certInfo.SerialNumber)
		{
		}

		// Token: 0x06000166 RID: 358 RVA: 0x000075C9 File Offset: 0x000065C9
		internal SubjectIdentifier(CAPIBase.CMSG_SIGNER_INFO signerInfo) : this(signerInfo.Issuer, signerInfo.SerialNumber)
		{
		}
		...
		internal unsafe SubjectIdentifier(CAPIBase.CRYPTOAPI_BLOB issuer, CAPIBase.CRYPTOAPI_BLOB serialNumber)
		{
			...
			CAPIBase.CERT_ISSUER_SERIAL_NUMBER pIssuerAndSerial;
