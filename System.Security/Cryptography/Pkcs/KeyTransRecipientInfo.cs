...
namespace System.Security.Cryptography.Pkcs
{
	...
	public sealed class KeyTransRecipientInfo : RecipientInfo
	{
		...
		internal unsafe KeyTransRecipientInfo(SafeLocalAllocHandle pRecipientInfo, CAPIBase.CERT_INFO certInfo, uint index) : base(RecipientInfoType.KeyTransport, RecipientSubType.Pkcs7KeyTransport, pRecipientInfo, certInfo, index)
		{
			int version = 2;
		...
		internal KeyTransRecipientInfo(SafeLocalAllocHandle pRecipientInfo, CAPIBase.CMSG_KEY_TRANS_RECIPIENT_INFO keyTrans, uint index) : base(RecipientInfoType.KeyTransport, RecipientSubType.CmsKeyTransport, pRecipientInfo, keyTrans, index)
		{
