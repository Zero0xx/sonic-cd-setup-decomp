...
namespace System.Security.Cryptography.Pkcs
{
	...
	public sealed class ContentInfo
	{
		...
		public static Oid GetContentType(byte[] encodedMessage)
		{
			...
			{
			case 1U:
				result = new Oid("1.2.840.113549.1.7.1");
				break;
			case 2U:
				result = new Oid("1.2.840.113549.1.7.2");
				break;
			case 3U:
				result = new Oid("1.2.840.113549.1.7.3");
				break;
			case 4U:
				result = new Oid("1.2.840.113549.1.7.4");
				break;
			case 5U:
				result = new Oid("1.2.840.113549.1.7.5");
				break;
			case 6U:
				result = new Oid("1.2.840.113549.1.7.6");
				break;
			default:
