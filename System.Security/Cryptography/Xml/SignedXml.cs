...
namespace System.Security.Cryptography.Xml
{
	...
	public class SignedXml
	{
		...
		public void ComputeSignature(KeyedHashAlgorithm macAlg)
		{
			...
			{
				if (<PrivateImplementationDetails>{64560308-E04C-427D-B380-143069BF5EFC}.$$method0x6000394-1 == null)
				{
					<PrivateImplementationDetails>{64560308-E04C-427D-B380-143069BF5EFC}.$$method0x6000394-1 = new Dictionary<string, int>(6)
					{
						{
							"SHA1",
							0
				...
				int num2;
				if (<PrivateImplementationDetails>{64560308-E04C-427D-B380-143069BF5EFC}.$$method0x6000394-1.TryGetValue(hashName, out num2))
				{
					switch (num2)
					{
					case 0:
