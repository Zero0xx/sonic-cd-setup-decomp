...
namespace Microsoft.CSharp
{
	...
	internal class CSharpCodeGenerator : ICodeCompiler, ICodeGenerator
	{
		...
		private string GetBaseTypeOutput(CodeTypeReference typeRef)
		{
			...
			if ((key = text2) != null)
			{
				if (<PrivateImplementationDetails>{825C30D4-A4CF-464C-B7EB-B8145854D1F8}.$$method0x6001706-1 == null)
				{
					<PrivateImplementationDetails>{825C30D4-A4CF-464C-B7EB-B8145854D1F8}.$$method0x6001706-1 = new Dictionary<string, int>(16)
					{
						{
							"system.int16",
							0
				...
				int num;
				if (<PrivateImplementationDetails>{825C30D4-A4CF-464C-B7EB-B8145854D1F8}.$$method0x6001706-1.TryGetValue(key, out num))
				{
					switch (num)
					{
					case 0:
