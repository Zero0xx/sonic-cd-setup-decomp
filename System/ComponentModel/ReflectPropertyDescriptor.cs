	...
	internal sealed class ReflectPropertyDescriptor : PropertyDescriptor
	{
		...
		protected override void FillAttributes(IList attributes)
		{
			...
			if (num > 0)
			{
				...
				while (baseType != null && baseType != typeof(object))
				{
					...
					if (this.IsExtender)
					{
						memberInfo = baseType.GetMethod("Get" + this.Name, bindingAttr);
					}
					else
					{
		...
		public override void ResetValue(object component)
		{
			...
			if (this.ResetMethodValue != null)
			{
				...
				if (componentChangeService != null)
				{
					oldValue = this.GetMethodValue.Invoke(invocationTarget, null);
					try
					{
				...
				if (this.ResetMethodValue != null)
				{
					...
					if (componentChangeService != null)
					{
						object newValue = this.GetMethodValue.Invoke(invocationTarget, null);
		...
		public override void SetValue(object component, object value)
		{
			if (component != null)
			{
				...
				if (!this.IsReadOnly)
				{
					...
					try
					{
						this.SetMethodValue.Invoke(invocationTarget, new object[]
						{
							value
						});
