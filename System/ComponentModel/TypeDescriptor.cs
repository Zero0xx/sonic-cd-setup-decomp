		...
		private static string GetExtenderCollisionSuffix(MemberDescriptor member)
		{
			...
			if (extenderProvidedPropertyAttribute != null)
			{
				...
				if (provider != null)
				{
					...
					{
						text = TypeDescriptor._collisionIndex++.ToString(CultureInfo.InvariantCulture);
					}
		...
		private static ICollection PipelineAttributeFilter(int pipelineType, ICollection members, Attribute[] filter, object instance, IDictionary cache)
		{
			...
			if (cache != null)
			{
				...
				case 1:
				{
					...
					list.CopyTo(array, 0);
					filteredMembers = new PropertyDescriptorCollection(array, true);
					break;
				}
				case 2:
				{
					...
					filteredMembers = new EventDescriptorCollection(array2, true);
					break;
				}
				default:
			...
			case 2:
				foreach (object obj2 in members)
				{
					...
					if (hashtable.Contains(name))
					{
						...
						{
							hashtable[name + extenderCollisionSuffix] = memberDescriptor;
						}
