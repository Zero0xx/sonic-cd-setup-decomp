...
namespace System.Text.RegularExpressions
{
	...
	public class Regex : ISerializable
	{
		...
		private Regex(string pattern, RegexOptions options, bool useCache)
		{
			...
			{
				threeLetterWindowsLanguageName = CultureInfo.InvariantCulture.ThreeLetterWindowsLanguageName;
			}
			else
			{
				threeLetterWindowsLanguageName = CultureInfo.CurrentCulture.ThreeLetterWindowsLanguageName;
			}
			...
			array[1] = ":";
			array[2] = threeLetterWindowsLanguageName;
			array[3] = ":";
			array[4] = pattern;
