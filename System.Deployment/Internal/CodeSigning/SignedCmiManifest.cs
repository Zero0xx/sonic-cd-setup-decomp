...
namespace System.Deployment.Internal.CodeSigning
{
	...
	internal class SignedCmiManifest
	{
		...
		private unsafe void VerifyLicense(CmiManifestVerifyFlags verifyFlags, bool oldFormat)
		{
			...
			{
				Win32.AXL_SIGNER_INFO signerInfo = default(Win32.AXL_SIGNER_INFO);
				...
				int num = Win32.CertVerifyAuthenticodeLicense(ref crypt_DATA_BLOB, (uint)verifyFlags, ref signerInfo, ref timestamperInfo);
				if (2148204800U != signerInfo.dwError)
				{
					this.m_authenticodeSignerInfo = new CmiAuthenticodeSignerInfo(signerInfo, timestamperInfo);
				}
