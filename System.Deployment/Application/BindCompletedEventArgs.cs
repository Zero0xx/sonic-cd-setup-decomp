...
namespace System.Deployment.Application
{
	...
	internal class BindCompletedEventArgs : AsyncCompletedEventArgs
	{
		...
		internal BindCompletedEventArgs(Exception error, bool cancelled, object userState, ActivationContext actCtx, string name, bool cached) : base(error, cancelled, userState)
		{
			this._actCtx = actCtx;
			this._name = name;
			this._cached = cached;
