...
namespace System.Deployment.Application
{
	...
	internal class UpdatePiece : ModalPiece
	{
		...
		private void InitializeContent()
		{
			...
			this.lblSubHeader.Text = string.Format(CultureInfo.CurrentUICulture, Resources.GetString("UI_UpdateSubHeader"), new object[]
			{
				UserInterface.LimitDisplayTextLength(this._info.productName)
			});
