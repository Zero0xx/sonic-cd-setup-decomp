...
namespace System.Deployment.Application
{
	...
	internal class SystemNetDownloader : FileDownloader
	{
		...
		protected void DownloadSingleFile(FileDownloader.DownloadQueueItem next)
		{
			...
			{
				string message = string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_FailedWhileDownloading"), new object[]
				{
					next._sourceUri
				});
			...
			{
				string message2 = string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_FailedWhileDownloading"), new object[]
				{
					next._sourceUri
				});
			...
			{
				string message3 = string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_FailedWhileDownloading"), new object[]
				{
					next._sourceUri
				});
