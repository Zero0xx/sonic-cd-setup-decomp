...
namespace System.Deployment.Application
{
	...
	internal class DefinitionAppId
	{
		...
		public DefinitionAppId(params DefinitionIdentity[] idPath) : this(null, idPath)
		{
		}
		...
		{
			return new DefinitionAppId(this.Codebase, new DefinitionIdentity[]
			{
		...
		private DefinitionIdentity PathComponent(uint index)
		{
			...
			try
			{
				...
				result = ((num == 1U) ? new DefinitionIdentity(array[0]) : null);
			}
			finally
			{
