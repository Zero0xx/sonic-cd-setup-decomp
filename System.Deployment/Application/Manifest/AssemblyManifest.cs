...
namespace System.Deployment.Application.Manifest
{
	...
	internal class AssemblyManifest
	{
		...
		public AssemblyManifest(string filePath)
		{
			...
			if (extension.Equals(".dll", comparisonType) || extension.Equals(".exe", comparisonType))
			{
		...
		public DefinitionIdentity Identity
		{
			get
			{
				...
				{
					DefinitionIdentity value;
					if (this._cms.Identity == null)
					{
						value = new DefinitionIdentity();
					}
					else
					{
						value = new DefinitionIdentity(this._cms.Identity);
					}
					Interlocked.CompareExchange(ref this._identity, value, null);
				}
			...
			get
			{
				if (this._description == null && this._cms != null)
				{
					...
					if (descriptionData != null)
					{
						...
						Interlocked.CompareExchange(ref this._description, value, null);
					}
				}
			...
			get
			{
				if (this._deployment == null && this._cms != null)
				{
					...
					if (deploymentData != null)
					{
						...
						Interlocked.CompareExchange(ref this._deployment, value, null);
					}
				}
			...
			get
			{
				if (this._dependentOS == null && this._cms != null)
				{
					...
					if (dependentOSData != null)
					{
						...
						Interlocked.CompareExchange(ref this._dependentOS, value, null);
					}
				}
			...
			get
			{
				if (this._dependentAssemblies == null)
				{
					...
					if (num > 0U)
					{
						...
						int errorCode = enumUnknown.Next(num, array2, ref num2);
						...
						{
							array[(int)((UIntPtr)num3)] = new DependentAssembly(array2[(int)((UIntPtr)num3)].AllData);
						}
					}
			...
			get
			{
				if (this._fileAssociations == null)
				{
					...
					if (num > 0U)
					{
						...
						for (uint num3 = 0U; num3 < num; num3 += 1U)
						{
							array[(int)((UIntPtr)num3)] = new FileAssociation(array2[(int)((UIntPtr)num3)].AllData);
						}
					}
			...
			get
			{
				if (this._files == null)
				{
					...
					if (num > 0U)
					{
						...
						for (uint num3 = 0U; num3 < num; num3 += 1U)
						{
							array[(int)((UIntPtr)num3)] = new File(array2[(int)((UIntPtr)num3)].AllData);
						}
					}
			...
			get
			{
				if (this._entryPoints == null)
				{
					...
					if (num > 0U)
					{
						...
						for (uint num3 = 0U; num3 < num; num3 += 1U)
						{
							array[(int)((UIntPtr)num3)] = new EntryPoint(array2[(int)((UIntPtr)num3)].AllData, this);
						}
					}
		...
		private void LoadCMSFromStream(Stream stream)
		{
			...
			catch (COMException innerException2)
			{
				...
				{
					stringBuilder.AppendFormat(CultureInfo.CurrentUICulture, Resources.GetString("Ex_ManifestParseCMSErrorMessage"), new object[]
					{
						manifestParseError.hr,
						manifestParseError.StartLine,
						manifestParseError.nStartColumn,
						manifestParseError.ErrorStatusHostFile
					});
				}
				throw new InvalidDeploymentException(ExceptionTypes.ManifestParse, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_ManifestCMSParsingException"), new object[]
				{
			...
			catch (SEHException innerException3)
			{
				...
				{
					stringBuilder2.AppendFormat(CultureInfo.CurrentUICulture, Resources.GetString("Ex_ManifestParseCMSErrorMessage"), new object[]
					{
						manifestParseError2.hr,
						manifestParseError2.StartLine,
						manifestParseError2.nStartColumn,
						manifestParseError2.ErrorStatusHostFile
					});
				}
				throw new InvalidDeploymentException(ExceptionTypes.ManifestParse, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_ManifestCMSParsingException"), new object[]
				{
			...
			catch (ArgumentException innerException4)
			{
				...
				{
					stringBuilder3.AppendFormat(CultureInfo.CurrentUICulture, Resources.GetString("Ex_ManifestParseCMSErrorMessage"), new object[]
					{
						manifestParseError3.hr,
						manifestParseError3.StartLine,
						manifestParseError3.nStartColumn,
						manifestParseError3.ErrorStatusHostFile
					});
				}
				throw new InvalidDeploymentException(ExceptionTypes.ManifestParse, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_ManifestCMSParsingException"), new object[]
				{
		...
		private bool LoadFromPEResources(string filePath)
		{
			...
			{
				AssemblyManifest.ManifestLoadExceptionHelper(exception, filePath);
			}
			if (array != null)
			{
		...
		private static DefinitionIdentity ExtractIdentityFromCompLibAssembly(string filePath)
		{
			...
			try
			{
				using (AssemblyMetaDataImport assemblyMetaDataImport = new AssemblyMetaDataImport(filePath))
				{
					...
					result = SystemUtils.GetDefinitionIdentityFromManagedAssembly(filePath);
				}
			}
		...
		private void LoadFromInternalManifestFile(string filePath)
		{
			...
			{
				AssemblyManifest.ManifestLoadExceptionHelper(exception2, filePath);
			}
			catch (InvalidDeploymentException exception3)
			{
				AssemblyManifest.ManifestLoadExceptionHelper(exception3, filePath);
			}
			finally
			{
				if (pestream != null)
		...
		internal void ValidateSemanticsForApplicationRole()
		{
			try
			{
				...
				{
					throw new InvalidDeploymentException(ExceptionTypes.InvalidManifest, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_TooManyFileAssociationsInManifest"), new object[]
					{
						8
					}));
				}
				...
				foreach (FileAssociation fileAssociation in this.FileAssociations)
				{
					...
					if (fileAssociation.Extension.Length > 0)
					{
						...
						if (c != '.')
						{
							throw new InvalidDeploymentException(ExceptionTypes.InvalidManifest, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_FileAssociationExtensionNoDot"), new object[]
							{
					...
					{
						throw new InvalidDeploymentException(ExceptionTypes.ManifestComponentSemanticValidation, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_FileAssociationInvalid"), new object[]
						{
							fileAssociation.Extension
						}));
					}
					...
					{
						throw new InvalidDeploymentException(ExceptionTypes.InvalidManifest, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_FileExtensionTooLong"), new object[]
						{
							fileAssociation.Extension
						}));
					}
					...
					{
						throw new InvalidDeploymentException(ExceptionTypes.InvalidManifest, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_FileAssociationIconFileNotFound"), new object[]
						{
							fileAssociation.DefaultIcon
						}));
					}
					if (hashtable2.Contains(fileAssociation.Extension))
					{
						throw new InvalidDeploymentException(ExceptionTypes.InvalidManifest, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_MultipleInstanceFileExtension"), new object[]
						{
							fileAssociation.Extension
						}));
					}
		...
		{
			AssemblyManifest.CertificateStatus result = AssemblyManifest.CertificateStatus.UnknownCertificateStatus;
			...
			try
			{
				...
				{
					result = AssemblyManifest.CertificateStatus.NoCertificate;
				}
				else
				{
					result = AssemblyManifest.CertificateStatus.TrustedPublisher;
				}
			}
			catch (Exception ex)
			{
				if (ex is CryptographicException && signedCmiManifest.AuthenticodeSignerInfo != null)
				{
					...
					{
						result = AssemblyManifest.CertificateStatus.DistrustedPublisger;
					}
					else if (errorCode == -2146885616)
					{
						result = AssemblyManifest.CertificateStatus.RevokedCertificate;
					}
					else if (errorCode == -2146762748)
					{
						result = AssemblyManifest.CertificateStatus.AuthenticodedNotInTrustedList;
					}
					else
					{
						result = AssemblyManifest.CertificateStatus.NoCertificate;
		...
		private static void ValidateAssemblyIdentity(DefinitionIdentity identity)
		{
			...
			{
				throw new InvalidDeploymentException(ExceptionTypes.ManifestComponentSemanticValidation, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_IdentityWithInvalidChars"), new object[]
				{
					identity.Name
				}));
			}
		...
		private void ValidateApplicationDependency(DependentAssembly da)
		{
			...
			{
				throw new InvalidDeploymentException(ExceptionTypes.ManifestComponentSemanticValidation, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_DepAppRefInvalidIdentityName"), new object[]
				{
					da.Identity.Name
				}));
			}
		...
		private static void ValidateComponentDependency(DependentAssembly da)
		{
			...
			if (!da.IsPreRequisite)
			{
				if (da.ResourceFallbackCulture == null)
				{
					if (AssemblyManifest.IsInvalidHash(da.HashCollection))
					{
						throw new InvalidDeploymentException(ExceptionTypes.ManifestComponentSemanticValidation, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_DependencyInvalidHash"), new object[]
						{
							da.Identity.ToString()
						}));
					}
					if (da.Codebase == null)
					{
						throw new InvalidDeploymentException(ExceptionTypes.ManifestComponentSemanticValidation, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_DependencyNoCodebase"), new object[]
						{
							da.Identity.ToString()
						}));
					}
					...
					{
						throw new InvalidDeploymentException(ExceptionTypes.ManifestComponentSemanticValidation, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_DependencyNotRelativePath"), new object[]
						{
							da.Identity.ToString()
						}));
					}
					...
					{
						throw new InvalidDeploymentException(ExceptionTypes.ManifestComponentSemanticValidation, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_DependencyOptionalButNoGroup"), new object[]
						{
							da.Identity.ToString()
						}));
					}
				...
				else if (da.Identity.Culture == null)
				{
					if (da.Codebase != null)
					{
						throw new InvalidDeploymentException(ExceptionTypes.ManifestComponentSemanticValidation, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_DependencyResourceWithCodebase"), new object[]
						{
							da.Identity.ToString()
						}));
					}
					...
					{
						throw new InvalidDeploymentException(ExceptionTypes.ManifestComponentSemanticValidation, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_DependencyResourceWithHash"), new object[]
						{
							da.Identity.ToString()
						}));
					}
				...
				else
				{
					...
					if (da.ResourceFallbackCulture != null)
					{
						throw new InvalidDeploymentException(ExceptionTypes.ManifestComponentSemanticValidation, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_DependencyResourceWithFallback"), new object[]
						{
							da.Identity.ToString()
						}));
					}
			...
			{
				throw new InvalidDeploymentException(ExceptionTypes.ManifestComponentSemanticValidation, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_DependencyGACNoPKT"), new object[]
				{
					da.Identity.ToString()
				}));
			}
			if (da.SupportUrl != null)
			{
				...
				{
					throw new InvalidDeploymentException(ExceptionTypes.ManifestComponentSemanticValidation, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_DependencySupportUrlNoAbsolute"), new object[]
					{
						da.Identity.ToString()
					}));
				}
				...
				{
					throw new InvalidDeploymentException(ExceptionTypes.InvalidManifest, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_DependencySupportUrlNotSupportedUriScheme"), new object[]
					{
						da.Identity.ToString()
					}));
				}
				...
				{
					throw new InvalidDeploymentException(ExceptionTypes.ManifestComponentSemanticValidation, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_DependencySupportUrlTooLong"), new object[]
					{
						da.Identity.ToString()
					}));
				}
		...
		private static void ValidateFile(File f)
		{
			...
			{
				throw new InvalidDeploymentException(ExceptionTypes.ManifestComponentSemanticValidation, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_InvalidFileHash"), new object[]
				{
					f.Name
				}));
			}
			...
			{
				throw new InvalidDeploymentException(ExceptionTypes.ManifestComponentSemanticValidation, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_FilePathNotRelative"), new object[]
				{
					f.Name
				}));
			}
			...
			{
				throw new InvalidDeploymentException(ExceptionTypes.ManifestComponentSemanticValidation, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_FileOptionalButNoGroup"), new object[]
				{
					f.Name
				}));
			}
			...
			{
				throw new InvalidDeploymentException(ExceptionTypes.ManifestComponentSemanticValidation, string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_FileOptionalAndData"), new object[]
				{
					f.Name
				}));
			}
		...
		internal static Uri UriFromMetadataEntry(string uriString, string exResourceStr)
		{
			...
			try
			{
				result = ((uriString != null) ? new Uri(uriString) : null);
			}
			catch (UriFormatException innerException)
			{
				throw new InvalidDeploymentException(ExceptionTypes.Manifest, string.Format(CultureInfo.CurrentUICulture, Resources.GetString(exResourceStr), new object[]
				{
					uriString
				}), innerException);
			}
		...
		private static void ManifestLoadExceptionHelper(Exception exception, string filePath)
		{
			...
			string message = string.Format(CultureInfo.CurrentUICulture, Resources.GetString("Ex_ManifestLoadFromFile"), new object[]
			{
				fileName
			});
