...
namespace System.Deployment.Application
{
	...
	internal static class ManifestValidatingReader
	{
		...
		private static XmlReader Create(Stream stream, XmlSchemaSet schemaSet)
		{
			...
			ManifestValidatingReader.XmlFilteredReader reader = new ManifestValidatingReader.XmlFilteredReader(stream);
		...
		private static string[] _manifestSchemas = new string[]
		{
