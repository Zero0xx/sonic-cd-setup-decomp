...
namespace System.Deployment.Application
{
	...
	public class GetManifestCompletedEventArgs : AsyncCompletedEventArgs
	{
		...
		internal GetManifestCompletedEventArgs(BindCompletedEventArgs e, ActivationDescription activationDescription, string logFilePath) : base(e.Error, e.Cancelled, e.UserState)
		{
