		...
		internal static EncoderParameters ConvertFromMemory(IntPtr memory)
		{
			...
			try
			{
				for (int i = 0; i < num; i++)
				{
					...
					int numberOfValues = Marshal.ReadInt32((IntPtr)((long)(i * num2) + num3 + 16L));
					int type = Marshal.ReadInt32((IntPtr)((long)(i * num2) + num3 + 20L));
					int value = Marshal.ReadInt32((IntPtr)((long)(i * num2) + num3 + 24L));
