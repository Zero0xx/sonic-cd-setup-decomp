...
namespace System.Runtime.Serialization.Formatters.Soap
{
	...
	internal sealed class PrimitiveArray
	{
		...
		internal string GetValue(int index)
		{
			...
			{
			case InternalPrimitiveTypeE.Boolean:
				result = this.booleanA[index].ToString();
				break;
			case InternalPrimitiveTypeE.Char:
				...
				{
					result = char.ToString(this.charA[index]);
				}
				break;
			case InternalPrimitiveTypeE.Double:
				...
				{
					result = this.doubleA[index].ToString("R", CultureInfo.InvariantCulture);
				}
				break;
			case InternalPrimitiveTypeE.Int16:
				result = this.int16A[index].ToString(CultureInfo.InvariantCulture);
				break;
			case InternalPrimitiveTypeE.Int32:
				result = this.int32A[index].ToString(CultureInfo.InvariantCulture);
				break;
			case InternalPrimitiveTypeE.Int64:
				result = this.int64A[index].ToString(CultureInfo.InvariantCulture);
				break;
			case InternalPrimitiveTypeE.SByte:
				result = this.sbyteA[index].ToString(CultureInfo.InvariantCulture);
				break;
			case InternalPrimitiveTypeE.Single:
				...
				{
					result = this.singleA[index].ToString("R", CultureInfo.InvariantCulture);
				}
				break;
			case InternalPrimitiveTypeE.UInt16:
				result = this.uint16A[index].ToString(CultureInfo.InvariantCulture);
				break;
			case InternalPrimitiveTypeE.UInt32:
				result = this.uint32A[index].ToString(CultureInfo.InvariantCulture);
				break;
			case InternalPrimitiveTypeE.UInt64:
				result = this.uint64A[index].ToString(CultureInfo.InvariantCulture);
				break;
			}
			return result;
		}
