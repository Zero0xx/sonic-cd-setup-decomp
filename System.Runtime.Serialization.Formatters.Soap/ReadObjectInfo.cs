...
namespace System.Runtime.Serialization.Formatters.Soap
{
	...
	internal sealed class ReadObjectInfo
	{
		...
		internal MemberInfo GetMemberInfo(string name)
		{
			if (this.isSi)
			{
				throw new SerializationException(string.Format(CultureInfo.CurrentCulture, SoapUtil.GetResourceString("Serialization_MemberInfo"), new object[]
				{
			...
			{
				throw new SerializationException(string.Format(CultureInfo.CurrentCulture, SoapUtil.GetResourceString("Serialization_NoMemberInfo"), new object[]
				{
					this.objectType + " " + name
				}));
			}
		...
		internal Type GetMemberType(MemberInfo objMember)
		{
			...
			else
			{
				...
				{
					throw new SerializationException(string.Format(CultureInfo.CurrentCulture, SoapUtil.GetResourceString("Serialization_SerMemberInfo"), new object[]
					{
						objMember.GetType()
					}));
				}
		...
		internal Type GetType(string name)
		{
			...
			if (type == null)
			{
				throw new SerializationException(string.Format(CultureInfo.CurrentCulture, SoapUtil.GetResourceString("Serialization_ISerializableTypes"), new object[]
				{
					this.objectType + " " + name
				}));
			}
		...
		internal Type GetType(int position)
		{
			...
			if (this.isTyped)
			{
				...
				result = this.cache.memberTypes[position];
			}
			return result;
		}
		...
		private int Position(string name)
		{
			...
			throw new SerializationException(string.Format(CultureInfo.CurrentCulture, SoapUtil.GetResourceString("Serialization_Position"), new object[]
			{
				this.objectType + " " + name
			}));
		}
